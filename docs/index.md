...
!!! info "Original course materials"
    ...
    Every page here derives from Professor Winfree's handout. Read it in his own words in the [transcribed syllabus](syllabus.md), or see the [original PDF](assets/aosd_syllabus.pdf).
...
1. **[Readings](readings.md).** Two required books, Adams's *Conceptual Blockbusting* and Ehrlich's *Nine Crazy Ideas in Science*, plus many short handouts. Winfree expected underlining, marginal notes, and "a page per class session to celebrate the best things you find or think of while involved with these readings."
2. **[Problems](problems/index.md).** "Problems, the equivalent of bar-bells for lifting." Write down your approaches, your lucky insights, and how you got into and out of blind alleys: "This is the main thing, not the 'answers'."
...
The problems are there to start a habit: a daily "Game's-Worth" of focused thought, named for the thought it takes to play one serious game of chess. Winfree wrote that this "might be the most important (potentially enduring) effect of the course." The [introduction](https://web.archive.org/web/20030114041921/http://eebweb.arizona.edu/faculty/winfree/SAS/asdIntro.html){target=_blank} 🔓 to his 2001-02 column *Adventures in Discovery* describes the same idea as a regular daily workout.

## Course Structure

The thirty class sessions fall into five sections:

- [Section 1: Detecting Nonsense, Error Checking, False Assumptions, Cherishing Mistakes](section1.md) (sessions 1 to 6): spotting nonsense and hidden assumptions, and putting facts before explanations of facts.
- [Section 2: Creative Blocks](section2.md) (sessions 7 to 12): the perceptual, emotional, cultural and intellectual blocks of Adams's book, and ways past them.
- [Section 3: Observations and Questions](section3.md) (sessions 13 to 18): careful observation, outdoors and in a chemical pattern-formation lab, including noticing what isn't there.
- [Section 4: Patterns, Empirical Generalizations](section4.md) (sessions 19 to 24): finding rules in data, often gathered in class labs such as Cell Shapes and Egg Pouches.
- [Section 5: Inferences, Hypotheses, Explanations](section5.md) (sessions 25 to 30): multiple working hypotheses and strong inference, then working out the theory of stacked cantilevers, LoShu, and the laws of a toy universe.

Also on this site:

- [The GamesWorth Method](gamesworth.md): the daily notebook, how to log it, and the "morning-after" left-hand pages.
- [Problems](problems/index.md): 55 problem pages, one for each problem and lab linked from the schedule, each with its statement, history, hints and sources.
- [Readings](readings.md): the reading list, each item marked open, borrowable or paywalled.
- [The Original Syllabus](syllabus.md): Winfree's handout transcribed in full, with the thirty-session schedule. It is the primary source for everything else on this site.
...
Start the daily GamesWorth habit now. Pick a problem from [Section 1](section1.md), set aside an uninterrupted hour, and log what you try. Winfree's warning: "form the GamesWorth habit immediately and don't let it slip for any 'reason'."
